...
class Graph:
    ...
    def dijkstra_shortest_path(self, source) :
        ...
        for i in range(1, self.node_count+1) :
            ...
            distance_surface = largetext.render(str(source) + " -> " + str(i) + ": " + str(distance[i]), True, RED)
...
def draw_node(node):
    ...
    nodeSurface = largetext.render(str(node.node_num), True, WHITE)
...
def draw_edge(edge, color, edge_width):
    ...
    if weight !=0:
        weight_label_surface = largetext.render(str(weight), True, color)
...
def draw_instruction():
    ...
    instructone_label_surface = mediumtext.render('Step 1: Click Inside Box to Add Nodes', True, BLACK)
    screen.blit(instructone_label_surface, (50, 460))

    instructtwo_label_surface = mediumtext.render('Step 2: Enter Src Node #, Dst Node # and Weight, Then Click "Add Edges"', True, BLACK)
    screen.blit(instructtwo_label_surface, (50, 490))

    instructthree_label_surface = mediumtext.render('Step 3: Click "Find Shortest Path"', True, BLACK)
