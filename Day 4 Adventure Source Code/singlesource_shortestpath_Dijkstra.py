...
# used to get the max integer value
# to initialize distance from the source
import sys
...
class Graph:
    ...
    def dijkstra_shortest_path(self, source) :
        ...
        distance = [sys.maxsize] * (self.node_count + 1)
        ...
        for i in range(1, self.node_count+1) :
            print("Source Node ("+str(source)+")  -> Destination Node(" +
                  str(i) + ")  : " + str(distance[i]))
