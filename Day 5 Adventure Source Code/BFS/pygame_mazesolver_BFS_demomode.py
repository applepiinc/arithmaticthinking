...
### demo mode ###
def get_all_coordinates(locations_in_queue):
    coord_str = ""
    for location in locations_in_queue.queue:
        i, j = find_coordinate(location)
...
def solve_maze():
    ...
    while not solved:
        ...
        if demo_mode:
            ...
            # starting location
            if not (currentI == startY and currentJ == startX):
        ...
        for neighbour in ["L", "R", "U", "D"]:
            ...
            if find_end(next_pos):
                ...
                if demo_mode:
                    ...
                    queue_str = get_all_coordinates(loc_queue)
